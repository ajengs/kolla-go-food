...
describe VouchersController do
  ...
  describe 'GET #index' do
    it 'populates an array of all vouchers' do
      voucher1 = create(:voucher, code: 'HEMAT5%')
      voucher2 = create(:voucher, code: 'DISC10K')
      get :index
  ...
  describe 'PATCH #update' do
    ...
    context 'with valid attributes' do
      ...
      it "changes @voucher's attributes (amount)" do
        patch :update, params: { id: @voucher, voucher: attributes_for(:voucher, amount: 12.5) }
        @voucher.reload
        expect(@voucher.amount).to eq(12.5)
      end
    ...
    context 'with invalid attributes' do
      it 'does not save the voucher in the database' do
        patch :update, params: { id: @voucher, voucher: attributes_for(:voucher, amount: 12000, unit: nil) }
        @voucher.reload
        expect(@voucher.amount).not_to eq(12000)
      end
  ...
  describe 'DELETE #destroy' do
    ...
    it 'redirects to voucher#index' do
      delete :destroy, params: { id: @voucher }
